...
IniFile::IniFile():
	m_pFile( NULL )
{
	memset( m_szFileName, 0, COMMON_CHAR_BUF_64 );
}
...
bool IniFile::LoadFile( const char* szFileName )
{
	...
	while( !IsEndOfFile() )
	{
		...
		lineNum++;
		ParseLine( strLine.c_str(), lineNum );
	}
...
bool IniFile::IsLeftBarce( const char c )
{
	return ( c == '[' );
}

bool IniFile::IsRigthBarce( const char c )
{
	return ( c == ']' );
}
...
void IniFile::ParseLine( std::string strLine, int lineNum )
{
...
//	assert(buf !=NULL);
//
//	errno_t error = fopen_s( &in, file, "r" );
//	if( NULL == in || error != 0 ) 
//	{
//		return 0;
//	}
...
//		{
//			strncpy_s(value, strlen(value) + 1, default_value, size);
//		}
//		return 0;
//	}
//
...
//		if(0==file_size)
//		{
//			sprintf_s(w_buf+file_size, MAX_INI_FILE_SIZE, "[%s]\n%s=%s\n",section,key,value);
//		}
//		else
//		{
//			//not find the section, then add the new section at end of the file
//			memcpy(w_buf,buf,file_size);
//			sprintf_s(w_buf+file_size, MAX_INI_FILE_SIZE, "\n[%s]\n%s=%s\n",section,key,value);
//		}
//	}
//	else if(-1 == key_s)
//	{
...
//		sprintf_s(w_buf+sec_e, MAX_INI_FILE_SIZE, "%s=%s\n",key,value);
//		sprintf_s(w_buf+sec_e+strlen(key)+strlen(value)+2,MAX_INI_FILE_SIZE, buf+sec_e, file_size - sec_e);
//	}
//	else
//	{
...
//	}
//
//	errno_t error = fopen_s( &out, file,"w" );
//	if(NULL == out || error != 0 )
//	{
//		return 0;
//	}
